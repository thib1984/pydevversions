...
```
pip3 uninstall pydevversions
pip uninstall pydevversions
pip3 uninstall pydevversions --break-system-packages
pip uninstall pydevversions --break-system-packages
```
